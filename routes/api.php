...
Route::delete('/children/{id}', 'ChildrenController@destroy')->middleware('api');
Route::put('/children/{id}', 'ChildrenController@update')->middleware('api');
...
Route::delete('/children/{cid}/remove_from_blacklist/{pid}', 'ChildrenController@removeFromBlacklist')->middleware('api');
...
Route::delete('/cards/{id}', 'CardsController@destroy')->middleware('api');
